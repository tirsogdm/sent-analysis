...
- Incorporating unigrams and bigrams as features
- Row-wise normalisation
"""
description = "Lemmas as features, filtering with (5, 250) frequency range, incorporating unigrams and bigrams, row-wise normalisation"
...
class CustomClassifier(Classifier):
    ...
    def get_feature_counts(self, data, is_test=False):
        ...
        if not is_test:
            ...
            self.cv_ngrams = CountVectorizer(ngram_range=(2, 2), min_df=5, max_df=1000)
            ...
            normalised_counts = self.row_wise_l2(combined_counts)
